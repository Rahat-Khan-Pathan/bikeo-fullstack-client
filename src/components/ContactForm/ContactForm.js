...
const ContactForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://immense-sierra-11894.herokuapp.com/contact", {
      method: "POST",
      headers: {
        ...
        <div className="wrap-login100">
          <form className="login100-form validate-form" onSubmit={handleSubmit}>
            ...
            <div className="wrap-input100 validate-input">
              <span className="label-input100 p-0 sp-color">Name</span>
              <input
                required
                ref={nameRef}
            ...
            {/* Input Email  */}
            <div className="wrap-input100 validate-input">
              <span className="label-input100 p-0 sp-color">Email</span>
              <input
                required
                ref={emailRef}
                className="input100 book-input"
            ...
            {/* Input Phone Number  */}
            <div className="wrap-input100 validate-input">
              <span className="label-input100 p-0 sp-color">Phone No.</span>
              <input
                required
                ref={phoneRef}
                className="input100 book-input"
            ...
            {/* Input for message  */}
            <div className="wrap-input100 validate-input">
              <span className="label-input100 p-0 sp-color">Message</span>
              <textarea
                required
                ref={messageRef}
