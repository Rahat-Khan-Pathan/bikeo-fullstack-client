...
const Form = (props) => {
  ...
  useEffect(() => {
    fetch(`https://immense-sierra-11894.herokuapp.com/bookProduct?userEmail=${user.email}&&id=${_id}`)
      .then((res) => res.json())
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://immense-sierra-11894.herokuapp.com/bookProduct", {
      method: "POST",
      headers: {
        ...
        <div className="container-login100 align-items-start py-0">
          <div className="wrap-login100">
            ...
            >
              ...
              {/* Input Phone Number  */}
              <div className="wrap-input100 validate-input">
                <span className="label-input100 sp-color p-0">Phone No.</span>
                <input
                  required
                  ref={phoneRef}
                  className="input100 book-input"
              ...
              {/* Input for address  */}
              <div className="wrap-input100 validate-input">
                <span className="label-input100 sp-color p-0">Address</span>
                <textarea
                  required
                  ref={addressRef}
